...
RUN set -ex \
 ...
 && MAVEN_OPTS="-Xmx2g -XX:MaxPermSize=1024m" /tmp/apache-maven-3.5.0/bin/mvn --batch-mode package -DskipTests -Pcassandra-spark-1.5 -Dspark.version=2.2.0 -Ppyspark -Psparkr -Pr -Pscala-2.11 -Pbuild-distr \
